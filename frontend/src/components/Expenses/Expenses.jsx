...
const Expenses = ({ setIsLoggedIn, setUserRole }) => {
    ...
    return (
        <div className="p-6 max-w-[1400px] mx-auto">
            ...
            {view === "view" ? (
                <ViewExpenses setIsLoggedIn={setIsLoggedIn} setUserRole={setUserRole} />
            ) : view === "create" ? (
                <CreateExpense setIsLoggedIn={setIsLoggedIn} setUserRole={setUserRole} setView={setView} />
            ) : (
                <VisualizeExpenses setIsLoggedIn={setIsLoggedIn} setUserRole={setUserRole} />
            )}
        </div>
    );
};
